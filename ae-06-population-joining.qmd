...
Highest: I would think that Asia is most likely.

Second Highest: I would think Africa is likely due to the continents large size.

Lowest: I would likely say Antarctica due to its harsh conditions.
...
I would likely chose different x-axis labels, as the "bil" suffix seems somewhat unprofessional depending on the setting in which the plot may be presented in.
